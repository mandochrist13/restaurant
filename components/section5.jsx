...
export default function Section5() {
  return (
    <div className="flex flex-col items-center space-y-10 justify-center w-full">
      <div className="flex flex-col bg-white md:flex-row space-y-6 shadow-2xl justify-between items-center p-5 w-full max-w-[1000px] mx-auto border border-gray-300 rounded-lg">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <div className="flex flex-col">
            ...
            <a href="tel:+24174000000" className="text-blue-400 text-center">
              +241 74 00 00 00
            </a>
          </div>
        </div>
